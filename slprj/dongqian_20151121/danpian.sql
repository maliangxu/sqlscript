...
--上周完成情况
select b.fml_bzdesc as fml_bzdesc_w,b.cmp_bzdesc as cmp_bzdesc_w from prj_items as a,prj_progress as b where a.id=b.pid and a.id=:prjnum and b.datatype="week" and b.proyear=:w_prev_year and b.promonth=:w_prev_month and b.proweek=:w_prev_week
