...
--插入年进度
insert or replace into prj_progress(pid,fml_complete,fml_rest,cmp_complete,cmp_rest,protime,proyear,datatype,ifshow,ifnew,timestps)
values (:prj_id,:fml_complete,:fml_rest,:cmp_complete,:cmp_rest,:y_time_year,:y_time,'year',1,1,:stamps)
...
--插入月进度
insert or replace into prj_progress(pid,fml_complete,fml_rest,cmp_complete,cmp_rest,protime,proyear,promonth,datatype,ifshow,ifnew,timestps)
values (:prj_id,:fml_complete,:fml_rest,:cmp_complete,:cmp_rest,:y_time_month,:y_time,:m_time,'month',1,1,:stamps)
...
--插入周进度
insert or replace into prj_progress(pid,fml_complete,fml_rest,cmp_complete,cmp_rest,protime,proyear,promonth,proweek,datatype,ifshow,ifnew,timestps)
values (:prj_id,:fml_complete,:fml_rest,:cmp_complete,:cmp_rest,:y_time_week,:y_time,:m_time,:w_time,'week',1,1,:stamps)
...
--插入季度进度
insert or replace into prj_progress(pid,fml_complete,fml_rest,cmp_complete,cmp_rest,protime,proyear,proseason,datatype,ifshow,ifnew,timestps)
values (:prj_id,:fml_complete,:fml_rest,:cmp_complete,:cmp_rest,:y_time_season,:y_time,:s_time,'season',1,1,:stamps)
