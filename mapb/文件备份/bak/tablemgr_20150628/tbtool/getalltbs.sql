...
select t.tb_id,t.tb_name,t.tb_alias,'4' as sharetype,'1' as owner from tb_list t
...
select t.tb_id,t.tb_name,t.tb_alias,src.sharetype,'2' as owner from
 tb_list t,sysdb_resources sr,sysdb_resControl src,sysdb_usergroups sug
...
select t.tb_id,t.tb_name,t.tb_alias,src.sharetype,'3' as owner from
  tb_list t,sysdb_resources sr,sysdb_resControl src
