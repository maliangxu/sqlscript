...
--该地图是分享给我所在的哪个组
--select 'sharegroup='|| groupname as sql_add_param from  sysdb_resControl rc,sysdb_resources r where rc.id=r.id and r.resid=:resid and r.restype='map' and r.resowner=:userid and  r.flag>=0 and rc.flag>=0
