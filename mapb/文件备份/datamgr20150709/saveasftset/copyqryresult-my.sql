...
--在g_ftset表中插入记录
insert into g_ftset(ftsetName,alias,shptype,coordsys,datasource,type,xmin,ymin,xmax,ymax) 
	select :ftsetname,:ftsetAlias,shptype,coordsys,:ftsetname,type,xmin,ymin,xmax,ymax 
