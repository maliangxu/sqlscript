...
--映射字段
insert into g_fieldsdef(field,tabname,fieldRealname,fieldtype,unit)
	select field, :newftsetab ,fieldRealname,fieldtype,unit from g_fieldsdef where tabname=  :copyftsetTab 
